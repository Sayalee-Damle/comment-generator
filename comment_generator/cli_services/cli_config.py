...
src_file_path = pathlib.Path(src_file_path.strip("\"")).as_posix()     #pathlib.Path(r"C:\Users\Sayalee\Projects\langchain\image_generator_bot").as_posix()  
...
if model_to_use.lower() == 'chat-gpt':
    ...
    print("Use TOGETHERAI for this, create an account and generate a key (https://docs.together.ai/docs/get-started)")
